...
@ActivityScoped
class MainViewModel @ViewModelInject constructor (@ApplicationContext context: Context, private val useCaseOne: UseCaseOne, private val useCaseTwo: UseCaseTwo) : ViewModel() {
